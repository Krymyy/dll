...
QT_MOC_LITERAL(3, 28, 17), // "rajapintaSignaali"
QT_MOC_LITERAL(4, 46, 8) // "tulostus"
...
void RfidDLL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RfidDLL *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signaaliRpSignaali(); break;
        case 1: _t->rajapintaSignaali(); break;
        case 2: { QString _r = _t->tulostus();
        ...
        {
            using _t = void (RfidDLL::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RfidDLL::signaaliRpSignaali)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RfidDLL::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_RfidDLL.data,
    qt_meta_data_RfidDLL,
    qt_static_metacall,
    nullptr,
    nullptr
} };
